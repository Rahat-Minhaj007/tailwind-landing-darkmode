...
const Hero = () => {
  ...
  return (
    <section className="text-gray-600 body-font dark:bg-gray-900 transition duration-500" style={{ background: `url(${themeMode === 'light' ? darkHero : lightHero}) center center/cover no-repeat`,height:"92vh" }}>
