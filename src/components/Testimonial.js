...
const Testimonial = () => {
    return (
        <section className="text-gray-600 body-font bg-gray-100 dark:bg-gray-800 dark:text-white" >
            <div className="container px-5 py-24 mx-auto">
                ...
                <div className="flex flex-wrap -m-4">
                    <div className="p-4 md:w-1/2 w-full">
                        <div className="h-full bg-gray-100 p-8 rounded dark:bg-gray-800 dark:text-white dark:shadow-2xl">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="block w-5 h-5 text-gray-400 dark:text-white mb-4" viewBox="0 0 975.036 975.036">
                            ...
                            <a className="inline-flex items-center">
                                ...
                                <span className="flex-grow flex flex-col pl-4">
                                    <span className="title-font font-medium text-gray-900 dark:text-white">Holden Caulfield</span>
                                    <span className="text-gray-500 text-sm dark:text-white">UI DEVELOPER</span>
                                </span>
                            </a>
                        </div>
                    </div>
                    <div className="p-4 md:w-1/2 w-full">
                        <div className="h-full bg-gray-100 p-8 rounded dark:bg-gray-800 dark:shadow-2xl dark:text-white">
                            ...
                            <a className="inline-flex items-center">
                                ...
                                <span className="flex-grow flex flex-col pl-4">
                                    ...
                                    <span className="text-gray-500 text-sm dark:text-white">DESIGNER</span>
                                </span>
                            </a>
                        </div>
                    </div>
