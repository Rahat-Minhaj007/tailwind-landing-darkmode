            ...
            <div className="container px-5 py-24 mx-auto">
                ...
                <div className="flex flex-wrap -m-4">
                    <div className="p-4 md:w-1/2 w-full">
                        <div className="h-full bg-gray-100 p-8 rounded dark:bg-gray-900 dark:text-white dark:shadow-2xl">
                    ...
                    <div className="p-4 md:w-1/2 w-full">
                        <div className="h-full bg-gray-100 p-8 rounded dark:bg-gray-900 dark:shadow-2xl dark:text-white">
