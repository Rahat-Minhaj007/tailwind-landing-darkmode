    ...
    <header className="text-gray-600 body-font bg-green-500 dark:bg-gray-800">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          {
            colorTheme === 'dark' ? <button onClick={() => setTheme(colorTheme)}><img src={dark} alt="" className="mx-3" style={{ width: '25px', objectFit: 'contain', cursor: 'pointer' }} /></button> : <button onClick={() => setTheme(colorTheme)}><img src={light} alt="" className="mx-3" style={{ width: '25px', objectFit: 'contain', cursor: 'pointer' }} /></button>
          }
