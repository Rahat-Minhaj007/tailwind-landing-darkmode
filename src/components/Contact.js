...
const Contact = () => {
    return (
        <section className="text-gray-600 body-font relative dark:bg-gray-900 transition duration-500">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-12">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base dark:text-white">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify.</p>
                </div>
                <div className="lg:w-1/2 md:w-2/3 mx-auto">
                    <div className="flex flex-wrap -m-2">
                        <div className="p-2 w-1/2">
                            <div className="relative">
                                <label for="name" className="leading-7 text-sm text-gray-600 dark:text-white">Name</label>
                        ...
                        <div className="p-2 w-1/2">
                            <div className="relative">
                                <label for="email" className="leading-7 text-sm text-gray-600 dark:text-white">Email</label>
                        ...
                        <div className="p-2 w-full">
                            <div className="relative">
                                <label for="message" className="leading-7 text-sm text-gray-600 dark:text-white">Message</label>
                        ...
                        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                            <a className="text-green-500 dark:text-white">example@email.com</a>
                            <p className="leading-normal my-5 dark:text-white">49 Smith St.
                            ...
                            <span className="inline-flex">
                                ...
                                <a className="ml-4 text-gray-500 dark:text-white">
                                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
